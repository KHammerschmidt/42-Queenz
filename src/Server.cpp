...
/* Setters */
void Server::setServerStatus(bool new_status)
{ 
	this->_serverRunningStatus = new_status;
}

/* Valid port checks are Checks for valid port and sets server status to running if input is valid. */
